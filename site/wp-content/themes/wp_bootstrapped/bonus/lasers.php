 ...
 */
function wp_bootstrapped_super_laser_defense() {
	$lasers = apply_filters( 'wp_bootstrapped_super_laser_defense', 'http://baldguy.files.wordpress.com/2011/07/pewpew.jpg' );

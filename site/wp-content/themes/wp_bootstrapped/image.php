					...
					<header class="entry-header">
						...
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Published <span class="entry-date"><abbr class="published" title="%1$s">%2$s</abbr></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%7$s</a>', 'wp_bootstrapped' ),
						...
						<nav id="image-navigation">
							<span class="previous-image"><?php previous_image_link( false, __( '&larr; Previous' , 'wp_bootstrapped' ) ); ?></span>
							<span class="next-image"><?php next_image_link( false, __( 'Next &rarr;' , 'wp_bootstrapped' ) ); ?></span>
					...
					<div class="entry-content">
						...
						<div class="entry-attachment">
							<div class="attachment">
								...
								$attachment_size = apply_filters( 'wp_bootstrapped_attachment_size', 1200 );
